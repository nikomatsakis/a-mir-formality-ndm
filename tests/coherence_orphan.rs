...
fn mirror_CoreStruct() {
    FormalityTest::new(crates![crate core {
            ...
            crate foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:53:1: no applicable rules for prove_normalize { p: CoreStruct, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }
...
fn alias_to_unit() {
    FormalityTest::new(crates![crate core {
            ...
            crate foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:53:1: no applicable rules for prove_normalize { p: (), assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }
