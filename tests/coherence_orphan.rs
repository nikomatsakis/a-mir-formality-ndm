...
fn mirror_CoreStruct() {
    FormalityTest::new(crates![crate core {
            ...
            crate foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:59:1: no applicable rules for prove_normalize_now { p: CoreStruct, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }
...
fn uncovered_T() {
    FormalityTest::new(crates![crate core {
            ...
            crate foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:59:1: no applicable rules for prove_normalize_now { p: !ty_0, assumptions: {}, env: Env { variables: [!ty_0], bias: Soundness, pending: [], allow_pending_outlives: false } }
...
fn alias_to_unit() {
    FormalityTest::new(crates![crate core {
            ...
            crate foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:59:1: no applicable rules for prove_normalize_now { p: (), assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }
