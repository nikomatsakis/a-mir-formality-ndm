...
fn if_else_different_return_types() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:65:1: no applicable rules for prove_normalize { p: bool, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:65:1: no applicable rules for prove_normalize { p: u32, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: true } }
...
fn test_pass_non_subtype_arg() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_normalize.rs:65:1: no applicable rules for prove_normalize { p: (), assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: true } }
