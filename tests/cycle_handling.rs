...
fn rooted_validation_cycle_cannot_invent_impl_for_ground_type() {
    ...
    .err(expect_test::expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:58:1: no applicable rules for prove_via_impl { requested_trait_ref: Ground: Trait, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 3 }, trait_impl: impl <ty> Trait for Wrapper<^ty0_0> where ^ty0_0 : Trait { } }, assumptions: {Supertraits[Trait](Wrapper<Ground>: Trait)}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: true } }"#]]);
}
...
fn grounded_supertrait_chain_rejects_type_without_debug_impl() {
    ...
    FormalityTest::new(grounded_supertrait_chain_program!(Bar))
        ...
        .err(expect_test::expect![[r#"
            ...
            crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:58:1: no applicable rules for prove_via_impl { requested_trait_ref: Bar: Debug, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 9 }, trait_impl: impl Debug for Foo { } }, assumptions: {Supertraits[A](Bar: A), Supertraits[B](Bar: B)}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]]);
}
