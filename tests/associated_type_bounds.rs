...
fn rust_135011_diverging_associated_type_cannot_supply_its_own_bound() {
    ...
    .err(expect_test::expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:51:1: no applicable rules for prove_via_impl { requested_trait_ref: !ty_0: MetaMetaImpossible, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 4 }, trait_impl: impl MetaMetaImpossible for () { type Assoc = () ; } }, assumptions: {GatBounds[MetaImpossible](!ty_0: MetaImpossible), GatBounds[MetaImpossible](!ty_0: MetaMetaImpossible)}, env: Env { variables: [!ty_0], bias: Soundness, pending: [], allow_pending_outlives: false } }
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:51:1: no applicable rules for prove_via_impl { requested_trait_ref: <!ty_0 as MetaMetaImpossible>::Assoc: MetaImpossible, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 3 }, trait_impl: impl <ty> MetaImpossible for ^ty0_0 where ^ty0_0 : MetaMetaImpossible { type Assoc = <<^ty1_0 as MetaMetaImpossible>::Assoc as MetaImpossible>::Assoc ; } }, assumptions: {GatBounds[MetaImpossible](!ty_0: MetaImpossible), GatBounds[MetaImpossible](!ty_0: MetaMetaImpossible)}, env: Env { variables: [!ty_0], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]]);
}
...
fn impl_wf_is_checked_for_every_header_substitution() {
    ...
    .err(expect_test::expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:51:1: no applicable rules for prove_via_impl { requested_trait_ref: !ty_0: Required, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 1 }, trait_impl: impl Required for u32 { } }, assumptions: {GatBounds[Family]((): Family<!ty_0>)}, env: Env { variables: [!ty_0], bias: Soundness, pending: [], allow_pending_outlives: false } }
...
fn assumption_preserving_alias_normalization_still_checks_the_normalized_type() {
    ...
    .err(expect_test::expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:51:1: no applicable rules for prove_via_impl { requested_trait_ref: Bar: Target<X>, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 6 }, trait_impl: impl <ty> Target <^ty0_0> for <^ty0_0 as Family>::Out where ^ty0_0 : Family { } }, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]]);
}
