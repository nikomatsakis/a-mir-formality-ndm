...
fn drop_impl_concrete_type_param() {
    ...
    .err(expect_test::expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:58:1: no applicable rules for prove_via_impl { requested_trait_ref: MyStruct<!ty_0>: Drop, candidate: ImplCandidate { id: ImplId { crate_index: 1, item_index: 1 }, trait_impl: impl Drop for MyStruct<u32> { } }, assumptions: {}, env: Env { variables: [!ty_0], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]])
}
