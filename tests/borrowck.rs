...
fn move_out_of_mut_ref() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:48:1: no applicable rules for prove_via_impl { requested_trait_ref: Copy(<&mut ?lt_0 Datum as Derefable>::Target), candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Copy for () { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }
