...
fn move_out_of_shared_ref() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:9:1: no applicable rules for prove_via_assumption { goal: <&?lt_0 Datum as Derefable>::Target: Copy, via: @ wf(?lt_0), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:9:1: no applicable rules for prove_via_assumption { goal: <&?lt_0 Datum as Derefable>::Target: Copy, via: @ wf(?lt_1), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Copy for () { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 10 }, trait_impl: impl Copy for bool { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 11 }, trait_impl: impl Copy for usize { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 12 }, trait_impl: impl Copy for isize { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 13 }, trait_impl: impl <lt, ty> Copy for &^lt0_0 ^ty0_1 where ^ty0_1 : ^lt0_0 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 2 }, trait_impl: impl Copy for u8 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 3 }, trait_impl: impl Copy for u16 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 4 }, trait_impl: impl Copy for u32 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 5 }, trait_impl: impl Copy for u64 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 6 }, trait_impl: impl Copy for i8 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 7 }, trait_impl: impl Copy for i16 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 8 }, trait_impl: impl Copy for i32 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 9 }, trait_impl: impl Copy for i64 { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }"#]])
}
...
fn move_out_of_mut_ref() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:9:1: no applicable rules for prove_via_assumption { goal: <&mut ?lt_0 Datum as Derefable>::Target: Copy, via: @ wf(?lt_0), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:9:1: no applicable rules for prove_via_assumption { goal: <&mut ?lt_0 Datum as Derefable>::Target: Copy, via: @ wf(?lt_1), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { requested_trait_ref: <&mut ?lt_0 Datum as Derefable>::Target: Copy, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Copy for () { } }, assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }
