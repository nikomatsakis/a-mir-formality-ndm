...
fn move_out_of_shared_ref() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: Copy(<&?lt_0 Datum as Derefable>::Target), via: @ wf(?lt_0), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: Copy(<&?lt_0 Datum as Derefable>::Target), via: @ wf(?lt_1), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Copy for () { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 10 }, trait_impl: impl Copy for bool { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 11 }, trait_impl: impl Copy for usize { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 12 }, trait_impl: impl Copy for isize { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 13 }, trait_impl: impl <lt, ty> Copy for &^lt0_0 ^ty0_1 where ^ty0_1 : ^lt0_0 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 2 }, trait_impl: impl Copy for u8 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 3 }, trait_impl: impl Copy for u16 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 4 }, trait_impl: impl Copy for u32 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 5 }, trait_impl: impl Copy for u64 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 6 }, trait_impl: impl Copy for i8 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 7 }, trait_impl: impl Copy for i16 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 8 }, trait_impl: impl Copy for i32 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 9 }, trait_impl: impl Copy for i64 { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }"#]])
}
...
fn move_out_of_mut_ref() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: Copy(<&mut ?lt_0 Datum as Derefable>::Target), via: @ wf(?lt_0), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: Copy(<&mut ?lt_0 Datum as Derefable>::Target), via: @ wf(?lt_1), assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }

                crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:50:1: no applicable rules for prove_via_impl { _requested_trait_ref: Copy(<&mut ?lt_0 Datum as Derefable>::Target), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Copy for () { } }, _assumptions: {@ wf(?lt_0), @ wf(?lt_1)}, _env: Env { variables: [?lt_0, ?lt_1], bias: Soundness, pending: [], allow_pending_outlives: true } }
...
fn undeclared_universal_region_relationship() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: !lt_1 : !lt_2, via: @ wf(?lt_0), assumptions: {@ wf(?lt_0)}, env: Env { variables: [!lt_1, !lt_2, ?lt_0], bias: Soundness, pending: [], allow_pending_outlives: false } }
...
fn undeclared_transitive_universal_region_relationship() {
    FormalityTest::new(crates![crate Foo {
                ...
                crates/formality-rust/src/prove/prove/prove/prove_via_assumption.rs:7:1: no applicable rules for prove_via_assumption { goal: !lt_0 : !lt_2, via: !lt_0 : !lt_1, assumptions: {!lt_0 : !lt_1}, env: Env { variables: [!lt_0, !lt_1, !lt_2], bias: Soundness, pending: [], allow_pending_outlives: false } }
