...
fn not_well_formed_adt() {
    ...
    .assert_err(expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:59:1: no applicable rules for prove_via_impl { _requested_trait_ref: Foo(u64), _candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Foo for u32 { } }, _assumptions: {}, _env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]]);
}
