...
fn not_well_formed_adt() {
    ...
    .assert_err(expect![[r#"
        ...
        crates/formality-rust/src/prove/prove/prove/prove_via_impl.rs:51:1: no applicable rules for prove_via_impl { requested_trait_ref: u64: Foo, candidate: ImplCandidate { id: ImplId { crate_index: 0, item_index: 1 }, trait_impl: impl Foo for u32 { } }, assumptions: {}, env: Env { variables: [], bias: Soundness, pending: [], allow_pending_outlives: false } }"#]]);
}
